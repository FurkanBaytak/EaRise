...
class BottomBarView extends StatefulWidget {
  const BottomBarView(
      {Key? key, this.tabIconsList, this.changeIndex, this.addClick, this.isNewScreen = false})
      : super(key: key);
...
class _BottomBarViewState extends State<BottomBarView>
  ...
  int selectedIndex = 2; // Başlangıçta ortadaki butonun seçili olduğunu belirtir
  bool isMic = true; // Ortadaki butonun mikrofon mu yoksa + mı olduğunu belirtir
  ...
  void initState() {
    ...
    widget.tabIconsList?[2].isSelected = true;
                            ...
                            Expanded(
                              child: TabIcons(
                                  ...
                                  removeAllSelect: () {
                                    ...
                                    setState(() {
                                      selectedIndex = 0;
                                      isMic = false; // Sağdaki ya da soldaki düğmeye basıldığında + simgesi
                                    });
                                  }),
                            ),
                            SizedBox(
                      ...
                      child: Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              // Mikrofon tuşuna basılınca başka bir işlev gerçekleştir
                              if (selectedIndex == 2) {
                              } else {
                                ...
                                setState(() {
                                  selectedIndex = 2;
                                  isMic = true; // Ortadaki düğmeye basıldığında mikrofon simgesi
                                });
                            ...
                            child: isMic
                              ...
                              size: 32,
                                ...
                                : Image.asset(
                              'assets/icons/middle.png', // 2. indexteki simge
                              width: 32,
                              height: 32,
                            ),
                          ),
